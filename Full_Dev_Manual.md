# 📖 Full Developer Manual — Indirect-Expense
> **Last updated:** 12 Mar 2026  
> เอกสารฉบับนี้เป็นการรวมคู่มือสำหรับนักพัฒนาทั้งฝั่ง **Backend** และ **Frontend** ของระบบ Indirect-Expense (ระบบจัดการเบิก Tooling) ไว้ในไฟล์เดียว เพื่อเป็นคู่มืออ้างอิงและใช้งานต่อยอด

---

<br><br><br>

# 🔴 PART 1: BACKEND DEVELOPER MANUAL 🔴
...
# 🔵 PART 2: FRONTEND DEVELOPER MANUAL 🔵
