-- =============================================
-- SP GM - PMC STYLE (Same column names as PMC)
-- Run this AFTER recreating tables
-- =============================================
...
BEGIN
    ...
    -- Date:           27/1/2569 (PMC Style - Same as PMC)
    -- Division_Id: 3 (GM)
    -- =============================================
    ...
    BEGIN TRY
        ...
        -- ==========================================================
        -- PART 1: UPDATE CUTTING (PMC Column Names)
        -- ==========================================================
        UPDATE T
        SET 
        ...
        -- ==========================================================
        -- PART 2: UPDATE SETUP (PMC Column Names)
        -- ==========================================================
        UPDATE T
        SET 
            T.Spec_ID = SPC.Spec_ID, 
        ...
        -- ==========================================================
        -- PART 3: INSERT CUTTING (PMC Column Names)
        -- ==========================================================
        ...
        -- ==========================================================
        -- PART 4: INSERT SETUP (PMC Column Names)
        -- ==========================================================
