...
get_Permission(): Observable<any> {
  return this.httpClient.get(`${this.baseUrl}/get_Permission`);
}
// add_Permission(data: any): Observable<any> {
//   return this.httpClient.post(`${this.baseUrl}/AddUserPermission`, data);
// }
update_Permission(id: string, data: any): Observable<any> {
  return this.httpClient.post(`${this.baseUrl}/updateEmployeePermission/${id}`, data);
}
// delete_Permission(id: string): Observable<any> {
//   return this.httpClient.delete(`${this.baseUrl}/DeleteEmployeePermission/${id}`);
// }
delete_Permission(Employee_ID: string): Observable<any> {
  return this.httpClient.delete(`${this.baseUrl}/DeleteEmployeePermission/${Employee_ID}`);
}
